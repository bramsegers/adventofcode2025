...
arr = (n, v) => (
  n = [...(n === +n ? Array(n) : n)],
  n = v === undefined ? n : n.map(v.call ? (_, i) => v(i) : _ => v)
)
...
Object.defineProperty(Array.prototype, 'fold', {
  value: function (f, ini) { return this.reduce(f, ini) },
  enumerable: false,
})

dims = grid => [len(grid), max(grid.map(len))]
